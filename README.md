...
### 🛠 Tech Stack & Tools
- **Languages:** Python (Pandas, FastAPI, yfinance)
- **Trading & Finance:** Technical analysis, Stock & Options strategies, Interactive Brokers API
- **Automation:** Pytest, API testing frameworks (pycamel)
- **Databases & Tools:** PostgreSQL, Docker, Git, Visual Studio
...
### 📫 How to reach me:
- **GitHub:** [@canyoupleasecreateanaccount](https://github.com/canyoupleasecreateanaccount)
